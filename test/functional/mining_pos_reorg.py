...
class ReorgStakeTest(PivxTestFramework):
    ...
    def check_money_supply(self, expected_piv, expected_zpiv):
        ...
        # verify that nodes have the expected KAGA and zKAGA supply
        for node in g_info:
            assert_equal(node['moneysupply'], DecimalAmt(expected_piv))
            for denom in node['zKAGAsupply']:
                assert_equal(node['zKAGAsupply'][denom], DecimalAmt(expected_zpiv[denom]))
    ...
    def run_test(self):
        ...
        # Check KAGA and zKAGA supply at the beginning
        # ------------------------------------------
        # zKAGA supply: 2 coins for each denomination
        ...
        # KAGA supply: block rewards minus burned fees for minting
        ...
        # Verify that KAGA and zKAGA supplies were properly updated after the spends and reorgs
        self.log.info("Check KAGA and zKAGA supply...")
