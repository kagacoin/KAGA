...
"""Verify that starting KAGA with -h works as expected."""
import subprocess
...
class HelpTest(PivxTestFramework):
    ...
    def run_test(self):
        self.log.info("Start KAGA with -? for help text")
        ...
        self.log.info("Start KAGA with -version for version information")
