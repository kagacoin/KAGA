...
/* KAGA GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "KAGA"
#define QAPP_ORG_DOMAIN "KAGA.org"
#define QAPP_APP_NAME_DEFAULT "KAGA-Qt"
#define QAPP_APP_NAME_TESTNET "KAGA-Qt-testnet"
