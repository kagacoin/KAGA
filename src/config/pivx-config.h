...
#define PACKAGE_BUGREPORT "https://github.com/kagacoin/KAGA"

/* Define to the full name of this package. */
#define PACKAGE_NAME "KAGA Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "KAGA Core 1.0.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "KAGA"

/* Define to the home page for this package. */
#define PACKAGE_URL "https://kagacoin.com/"
