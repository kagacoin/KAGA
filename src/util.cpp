...
const char * const PIVX_CONF_FILENAME = "KAGA.conf";
const char * const PIVX_PID_FILENAME = "KAGA.pid";
...
{
// Windows < Vista: C:\Documents and Settings\Username\Application Data\KAGA
// Windows >= Vista: C:\Users\Username\AppData\Roaming\KAGA
// Mac: ~/Library/Application Support/KAGA
// Unix: ~/.KAGA
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "KAGA";
#else
    fs::path pathRet;
    ...
    std::map<std::string, std::vector<std::string> >& mapMultiSettingsRet)
{
    ...
    if (!streamConfig.good()) {
        // Create empty KAGA.conf if it does not exist
        ...
        if (configFile != NULL) {
	        ...
	        strHeader += "\nrpcport=16101\naddnode=seed1.kagacoin.com:16102\naddnode=seed2.kagacoin.com:16102\naddnode=seed3.kagacoin.com:16102\naddnode=seed4.kagacoin.com:16102\naddnode=seed5.kagacoin.com:16102\naddnode=seed6.kagacoin.com:16102\naddnode=seed7.kagacoin.com:16102\naddnode=seed8.kagacoin.com:16102\n";
    ...
    for (boost::program_options::detail::config_file_iterator it(streamConfig, setOptions), end; it != end; ++it) {
        // Don't overwrite existing settings so command line settings override KAGA.conf
