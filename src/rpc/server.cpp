...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* KAGA features */
        {"KAGA", "listmasternodes", &listmasternodes, true },
        {"KAGA", "getmasternodecount", &getmasternodecount, true },
        {"KAGA", "createmasternodebroadcast", &createmasternodebroadcast, true },
        {"KAGA", "decodemasternodebroadcast", &decodemasternodebroadcast, true },
        {"KAGA", "relaymasternodebroadcast", &relaymasternodebroadcast, true },
        {"KAGA", "masternodecurrent", &masternodecurrent, true },
        {"KAGA", "startmasternode", &startmasternode, true },
        {"KAGA", "createmasternodekey", &createmasternodekey, true },
        {"KAGA", "getmasternodeoutputs", &getmasternodeoutputs, true },
        {"KAGA", "listmasternodeconf", &listmasternodeconf, true },
        {"KAGA", "getmasternodestatus", &getmasternodestatus, true },
        {"KAGA", "getmasternodewinners", &getmasternodewinners, true },
        {"KAGA", "getmasternodescores", &getmasternodescores, true },
        {"KAGA", "mnsync", &mnsync, true },
        {"KAGA", "spork", &spork, true },
...
{
    return "> KAGA-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(std::string methodname, std::string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:16101/\n";
}
