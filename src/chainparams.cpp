...
{
    const char* pszTimestamp = "KAGA guarantee the full repayment and wealth development worldwide";
...
static Checkpoints::MapCheckpoints mapCheckpoints =
    ...
    (1500, uint256("0x174c8763e05783dd793d6f741d7480acbd3fc2baaf76eee471293aaa66e7a696"))
;
static const Checkpoints::CCheckpointData data = {
    &mapCheckpoints,
    1760350740, // * UNIX timestamp of last checkpoint block
...
public:
    CMainParams()
    {
        ...
        genesis = CreateGenesisBlock(1760350740, 15576101, 0x1e0ffff0, 1, 0 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();


        assert(consensus.hashGenesisBlock == uint256S("0x00000f60d19b57f5d6eaccea8e3b1d14ebdadfc2692c7cc761d16ef671e52701"));
        assert(genesis.hashMerkleRoot == uint256S("0xb4ad76393615a2f83dac0662a209651a10b00d004d37c3ff61a669d6b6941485"));
        ...
        consensus.mBurnAddresses = {
           { "KAGABuRnKAGAxxxxxxxxxxxxTpDJ6", 0 }
        };
	...
	vSeeds.push_back(CDNSSeedData("seed1",  "seed1.kagacoin.com"));
        vSeeds.push_back(CDNSSeedData("seed2",  "seed2.kagacoin.com"));
        vSeeds.push_back(CDNSSeedData("seed3",  "seed3.kagacoin.com"));
        vSeeds.push_back(CDNSSeedData("seed4",  "seed4.kagacoin.com"));
        vSeeds.push_back(CDNSSeedData("seed5",  "seed5.kagacoin.com"));
        vSeeds.push_back(CDNSSeedData("194.242.56.101",  "194.242.56.101"));
...
public:
    CTestNetParams()
    {
        ...
        genesis = CreateGenesisBlock(1760350740, 2402015, 0x1e0ffff0, 1, 250 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        //assert(consensus.hashGenesisBlock == uint256S("0x0000041e482b9b9691d98eefb48473405c0b8ec31b76df3797c74a78680ef818"));
        //assert(genesis.hashMerkleRoot == uint256S("0x1b2ef6e2f28be914103a277377ae7729dcd125dfeb8bf97bd5964ba72b6dc39b"));

        consensus.fPowAllowMinDifficultyBlocks = true;
        consensus.powLimit   = ~UINT256_ZERO >> 20;   // KAGA starting difficulty is 1 / 2^12
        consensus.posLimitV1 = ~UINT256_ZERO >> 24;
        consensus.posLimitV2 = ~UINT256_ZERO >> 20;
        ...
        vSeeds.push_back(CDNSSeedData("tseeder", "tseeder.__kagacoin.com__", true));

        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 139); // Testnet KAGA addresses start with 'x' or 'y'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1, 19);  // Testnet KAGA script addresses start with '8' or '9'
        base58Prefixes[SECRET_KEY] = std::vector<unsigned char>(1, 239);     // Testnet private keys start with '9' or 'c' (Bitcoin defaults)
        // Testnet KAGA BIP32 pubkeys start with 'DRKV'
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x3a)(0x80)(0x61)(0xa0).convert_to_container<std::vector<unsigned char> >();
        // Testnet KAGA BIP32 prvkeys start with 'DRKP'
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x3a)(0x80)(0x58)(0x37).convert_to_container<std::vector<unsigned char> >();
        // Testnet KAGA BIP44 coin type is '1' (All coin's testnet default)
