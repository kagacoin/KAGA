...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("KAGA KAGA-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  KAGA-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded KAGA transaction") + "\n" +
                               "  KAGA-tx [options] -create [commands]   " + _("Create hex-encoded KAGA transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded KAGA transaction
