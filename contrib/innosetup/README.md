...
* Fill in the following data:
    * Application Name: `KAGA Core`
    * Application Version: `2.0.0.0`
    * Application Publisher: `2025-2026 The KAGA Developers`
    * Application Website: `https://kagacoin.com/`
* Setup the destination folder:
    * Program Files Folder
    * Folder name: `KAGA`
* Add application files:
    * Select the file `KAGA-qt.exe` as main executable from the `package` folder
...
* Compiler settings
    ...
    * Edit the output base filename to: `KAGA-2.0.0-win64-setup.exe`
