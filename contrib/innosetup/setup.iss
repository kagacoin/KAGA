...
#define MyAppName "KAGA Core"
#define MyAppPublisher "2025-2026 The KAGA Developers"
#define MyAppURL "https://github.com/kagacoin/KAGA"
#define MyAppExeName "KAGA-qt.exe"
#define MyAppExtraData "https://github.com/kagacoin/KAGA/releases/download/v2.0/bootstrap.zip"
...
[Files]
Source: ".\package\KAGA-qt.exe"; DestDir: "{app}"; Flags: ignoreversion; Components: app
...
[Registry]
Root: "HKCU"; Subkey: "Software\KAGA\KAGA-Qt"; ValueType: string; ValueName: "strDataDir"; ValueData: "{code:GetDataDir}\"
...
begin
  ...
  if DataDirPage.Values[0] = '' then
     DataDirPage.Values[0] := ExpandConstant('{reg:HKCU\Software\KAGA\KAGA-Qt,strDataDir|{userappdata}\KAGA\}');
  Result := True;
end;
