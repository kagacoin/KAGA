...
TMP_FOLDER=$(mktemp -d)
CONFIG_FILE='KAGA.conf'
CONFIGFOLDER='/root/.KAGA'
COIN_DAEMON='KAGAd'
COIN_CLI='KAGA-cli'
COIN_PATH='/usr/local/bin/'
COIN_TGZ=`curl -s https://api.github.com/repos/KAGA/KAGA/releases/latest | grep "browser_download_url.*Linux\\.zip" | cut -d : -f 2,3 | tr -d \" | xargs`
