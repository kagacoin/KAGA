Contributing to KAGA Core
============================

The KAGA Core project operates an open contributor model where anyone is
...
The following applies to code changes to the KAGA Core project, and is not to be
confused with overall KAGA Network Protocol consensus changes.

Whether a pull request is merged into KAGA Core rests with the project merge
...
Patches that change KAGA consensus rules are considerably more involved than
...
Where a patchset proposes to change the KAGA consensus, it must have been
...
The project leader is the release manager for each KAGA Core release.
