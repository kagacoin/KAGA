...
KAGA.conf           | contains configuration settings for KAGAd or KAGA-qt
KAGAd.pid           | stores the process id of KAGAd while running
...
debug.log           | contains debug information and general logging generated by KAGAd or KAGA-qt
